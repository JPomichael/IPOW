...
namespace iPow.Infrastructure.Crosscutting.EntityToDto
{
    public static class iPowPreEntityToDto
    {
        ...
        public static iPow.Domain.Dto.Sys_MvcControllerActionDto ToDto(this iPow.Infrastructure.Data.DataSys.Sys_MvcControllerAction entity)
        {
    		return EmitMapper.ObjectMapperManager.DefaultInstance
                    .GetMapper<iPow.Infrastructure.Data.DataSys.Sys_MvcControllerAction, iPow.Domain.Dto.Sys_MvcControllerActionDto>().Map(entity);
        }
        ...
        {
    		return EmitMapper.ObjectMapperManager.DefaultInstance
                    .GetMapper<iPow.Infrastructure.Data.DataSys.Sys_MvcControllerAction, iPow.Domain.Dto.Sys_MvcControllerActionDto>().MapEnum(entity);
        }
        ...
        {
    		return EmitMapper.ObjectMapperManager.DefaultInstance
                    .GetMapper<iPow.Infrastructure.Data.DataSys.Sys_MvcControllerActionClass, iPow.Domain.Dto.Sys_MvcControllerActionClassDto>().Map(entity);
        }
        ...
        {
    		return EmitMapper.ObjectMapperManager.DefaultInstance
                    .GetMapper<iPow.Infrastructure.Data.DataSys.Sys_MvcControllerActionClass, iPow.Domain.Dto.Sys_MvcControllerActionClassDto>().MapEnum(entity);
        }
        ...
        {
    		return EmitMapper.ObjectMapperManager.DefaultInstance
                    .GetMapper<iPow.Infrastructure.Data.DataSys.Sys_MvcControllerClass, iPow.Domain.Dto.Sys_MvcControllerClassDto>().Map(entity);
        }
        ...
        {
    		return EmitMapper.ObjectMapperManager.DefaultInstance
                    .GetMapper<iPow.Infrastructure.Data.DataSys.Sys_MvcControllerClass, iPow.Domain.Dto.Sys_MvcControllerClassDto>().MapEnum(entity);
        }
        ...
        {
    		return EmitMapper.ObjectMapperManager.DefaultInstance
                    .GetMapper<iPow.Infrastructure.Data.DataSys.Sys_MvcControllerRolePermission, iPow.Domain.Dto.Sys_MvcControllerRolePermissionDto>().MapEnum(entity);
        }
        ...
        public virtual ObjectResult<Sys_SightInfo> Sys_SightInfoSearch(string search)
        {
            ((IObjectContextAdapter)this).ObjectContext.MetadataWorkspace.LoadFromAssembly(typeof(Sys_SightInfo).Assembly);
    
            var searchParameter = search != null ?
                new ObjectParameter("Search", search) :
                new ObjectParameter("Search", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Sys_SightInfo>("Sys_SightInfoSearch", searchParameter);
        }
    
        public virtual ObjectResult<Sys_SightInfo> Sys_SightInfoSearch(string search, MergeOption mergeOption)
        {
            ((IObjectContextAdapter)this).ObjectContext.MetadataWorkspace.LoadFromAssembly(typeof(Sys_SightInfo).Assembly);
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Sys_SightInfo>("Sys_SightInfoSearch", mergeOption, searchParameter);
        }
    
        public virtual ObjectResult<Nullable<bool>> Sys_ExistsByUserID(Nullable<int> iD)
        {
            var iDParameter = iD.HasValue ?
                new ObjectParameter("ID", iD) :
                new ObjectParameter("ID", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Nullable<bool>>("Sys_ExistsByUserID", iDParameter);
        }
    
        public virtual int Sys_CreateUser(string userName, string password, string trueName, string sex, string phone, string email, Nullable<int> employeeID, string departmentID, Nullable<bool> activity, string userType, ObjectParameter iD, Nullable<int> style)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("Sys_CreateUser", userNameParameter, passwordParameter, trueNameParameter, sexParameter, phoneParameter, emailParameter, employeeIDParameter, departmentIDParameter, activityParameter, userTypeParameter, iD, styleParameter);
        }
    
        public virtual int Sys_AddUserToRole(Nullable<int> userID, Nullable<int> roleID)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("Sys_AddUserToRole", userIDParameter, roleIDParameter);
        }
    
        public virtual int Sys_DeleteByUserID(Nullable<int> userID)
        {
            var userIDParameter = userID.HasValue ?
                new ObjectParameter("UserID", userID) :
                new ObjectParameter("UserID", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("Sys_DeleteByUserID", userIDParameter);
        }
    
        public virtual int Sys_PermissionByUserId(string userId, string permissionId)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("Sys_PermissionByUserId", userIdParameter, permissionIdParameter);
        }
    
        public virtual int Sys_UpdatePassword(Nullable<int> userID, string password)
        {
            var userIDParameter = userID.HasValue ?
                new ObjectParameter("UserID", userID) :
                new ObjectParameter("UserID", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("Sys_UpdatePassword", userIDParameter, passwordParameter);
        }
    
        public virtual int Sys_UpdateUser(Nullable<int> iD, string trueName, string password, string sex, string phone, string email, Nullable<int> employeeID, string departmentID, Nullable<bool> activity, string userType, Nullable<int> style)
        {
            var iDParameter = iD.HasValue ?
                new ObjectParameter("ID", iD) :
                new ObjectParameter("ID", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("Sys_UpdateUser", iDParameter, trueNameParameter, passwordParameter, sexParameter, phoneParameter, emailParameter, employeeIDParameter, departmentIDParameter, activityParameter, userTypeParameter, styleParameter);
        }
    
        public virtual int Sys_ExistsByUserName(string userName)
        {
            var userNameParameter = userName != null ?
                new ObjectParameter("UserName", userName) :
                new ObjectParameter("UserName", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("Sys_ExistsByUserName", userNameParameter);
        }
    }
}
