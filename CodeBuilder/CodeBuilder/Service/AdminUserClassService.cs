...
namespace iPow.Application.SysService
{
    public class AdminUserClassService : IAdminUserClassService
    {
            ...
            public bool Add(IList<iPow.Infrastructure.Data.DataSys.Sys_AdminUserClass> entity, iPow.Infrastructure.Data.DataSys.Sys_AdminUser operUser)
            {
                var res = false;
     ...
     public bool Delete(iPow.Infrastructure.Data.DataSys.Sys_AdminUserClass entity, iPow.Infrastructure.Data.DataSys.Sys_AdminUser operUser)
            ...
            public bool Delete(IList<iPow.Infrastructure.Data.DataSys.Sys_AdminUserClass> entity, iPow.Infrastructure.Data.DataSys.Sys_AdminUser operUser)
            {
                var res = false;
                if (entity != null && entity.Count > 0)
                {
            ...
            public bool DeleteTrue(iPow.Infrastructure.Data.DataSys.Sys_AdminUserClass entity, iPow.Infrastructure.Data.DataSys.Sys_AdminUser operUser)
            {
                var res = false;
                if (entity != null)
                {
            ...
            public bool DeleteTrue(IList<iPow.Infrastructure.Data.DataSys.Sys_AdminUserClass> entity, iPow.Infrastructure.Data.DataSys.Sys_AdminUser operUser)
            {
                var res = false;
                if (entity != null && entity.Count > 0)
                {
            ...
            public bool Modify(iPow.Infrastructure.Data.DataSys.Sys_AdminUserClass entity, iPow.Infrastructure.Data.DataSys.Sys_AdminUser operUser)
            {
                var res = false;
            ...
            public bool Modify(IList<iPow.Infrastructure.Data.DataSys.Sys_AdminUserClass> entity, iPow.Infrastructure.Data.DataSys.Sys_AdminUser operUser)
            {
                var res = false;
                if (entity != null && entity.Count > 0)
                {
    		    ...
    		    public iPow.Infrastructure.Data.DataSys.Sys_AdminUserClass Get(int id)
            {
            ...
            public int GetMaxId()
            {
                 var res = adminUserClassRepository.GetList().Max(e => e.Id);
                return res;
            }
